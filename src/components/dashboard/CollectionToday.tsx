...
const CollectionToday = ({collection}: IProps) => {
  ...
  return (
    <div className="w-full overflow-hidden rounded-2xl" ref={containerRef}>
      <div className="flex items-center justify-between border-b-[1px] border-black/20 bg-dashboardSecondaryColorL/90 dark:bg-dashboardSecondaryColor/30 p-4">
      ...
      {showTasks && (
        <div className="border-b border-dashboardSecondaryColor/50 bg-secondaryColorL dark:bg-secondaryColor">
      ...
      <div onClick={navigateToCollection} className="group flex cursor-pointer items-center justify-center bg-secondaryColorL dark:bg-secondaryColor p-4 hover:bg-secondaryColorL/80 hover:dark:bg-secondaryColor/90">
        <div className="flex items-center justify-center gap-1  text-textColorL/90 dark:text-textColor/95">
